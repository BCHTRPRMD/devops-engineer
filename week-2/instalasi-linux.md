...
![bahasa pic](assets/bahasa.png)

### Pilih Keyboard layout

![layout pic](assets/layout.png)

### Melakukan konfigurasi IPv4 untuk penggunaan IP Statis

![konfigurasi-1 pic](assets/konfigurasi-1.png)

### Melakukan konfigurasi IPv4 Method dari Automatic DHCP menjadi Static IP

![konfigurasi-2 pic](assets/konfigurasi-2.png)
![konfigurasi-3 pic](assets/konfigurasi-3.png)
...
![konfigurasi-storage pic](assets/storage-1.png)
![konfigurasi-storage2 pic](assets/storage-2.png)

### Membuat partisi swap dan root sesuai dengan keperluan

![konfigurasi-storage3 pic](assets/storage-3.png)
![konfigurasi-storage3 pic](assets/storage-4.png)

### Berikut merupakan hasil swap dan root

![konfigurasi-storage3 pic](assets/storage-5.png)

### Melakukan konfigurasi profile untuk login ke dalam sistem

![konfigurasi-profile pic](assets/profile-setup.png)

### Melakukan install OpenSSH dengan memilih Install OpenSSH server

![konfigurasi-openssh pic](assets/ssh-setup.png)

### Berikut merupakan proses instalasi ketika berlangsung hingga proses reboot

![installasi pic](assets/proses-install.png)
![reboot pic](assets/reboot.png)
